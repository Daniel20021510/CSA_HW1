...
int main(int argc, char* argv[]){
    ...
    Out(container, output_file);

    fprintf(output_file, "\n===================================================================================\n");
    fprintf(output_file, "\n=============================== Straight Insertion  ===============================\n\n");
    printf("Sorting elements\n");
    StraightInsertion(container);
    Out(container, output_file);
    Clear(container);
    container = NULL;
    fclose(output_file);
