...
#ifndef CSA_HW1_FLAGS_WORKER_H
#define CSA_HW1_FLAGS_WORKER_H

#include <unistd.h>

#define HELP_MESSAGE    "CSA Homework 1. Plants with Straight Insertion.\n"                                 \
                        "Task: 13, Function: 10\n\n"                                                        \
                        "Program options:\n\n"                                                              \
                        "\t-i - Set input file\n"                                                           \
                        "\t-o - Set output file\n"                                                          \
